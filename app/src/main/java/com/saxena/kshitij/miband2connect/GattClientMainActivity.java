...
public class GattClientMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create new button for this actions
        Button initialBtn = (Button) findViewById(R.id.getInitializeButton);
        Button disconBtn = (Button) findViewById(R.id.getDisconnect);
    ...
    private void handleGenericAccess(BluetoothGattCharacteristic characteristic) {
        String value = characteristic.getStringValue(0);
        Log.d("TAG", "onCharacteristicRead: " + value + " UUID " + characteristic.getUuid().toString());
       //devStatus.setText("onCharacteristicRead: " + value + " UUID " + characteristic.getUuid().toString());
        synchronized (object) {
            object.notify();
        }
    }
    ...
    private void authoriseMiBand() {
        ...
        for (BluetoothGattDescriptor descriptor : characteristic.getDescriptors()) {
            if (descriptor.getUuid().equals(UUIDs.CUSTOM_SERVICE_AUTH_DESCRIPTOR)) {
               ...
               // devStatus.setText("Found NOTIFICATION BluetoothGattDescriptor: " + descriptor.getUuid().toString());
    ...
    private void getDeviceInformation() {
            ...
            devStatus.setText("get device information");
           try {
    ...
    private void getGenericAccessInfo() {
        ...
        devStatus.setText("get Generic Access info");
        try {
    ...
    private void connectDevice(BluetoothDevice miBand) {
        ...
        if (miBand.getBondState() == BluetoothDevice.BOND_NONE) {
            ...
            Toast.makeText(getApplicationContext(),"device created!",Toast.LENGTH_LONG).show();
        }
        else {
